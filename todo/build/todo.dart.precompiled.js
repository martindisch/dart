...
y=$.yj
$.yj=J.WB(y,1)
return new Function("F",x+H.d(y)+"}")(a)}else return H.rc(z,a)},
...
z.h(z,new P.fZ(b,null))}},"call$1","ght",2,0,function(){return H.IG(function(a){return{func:"lU",void:true,args:[a]}},this.$receiver,"Kd")}],
xO:function(a){var z,y
z=this.Gv
...
"":"Tp:11;",
call$1:function(a){var z=J.x(a)
return typeof a==="object"&&a!==null&&!!z.$iscv}}}],["","file:///C:/Users/Martin/dart/todo/web/todo.dart",,N,{
"":"",
Iq:[function(){$.of=document.querySelector("#to-do-input")
$.MS=document.querySelector("#to-do-list")
var z=document.querySelector("#delete-all")
$.LV=z
z.toString
z=H.VM(new W.Cq(z,C.T1.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new N.em()),z.Sg),[H.Kp(z,0)]).Zz()
z=$.of
z.toString
z=H.VM(new W.Cq(z,C.mt.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(N.vq()),z.Sg),[H.Kp(z,0)]).Zz()
N.Yy()},"call$0","eE",0,0,0],
DS:[function(a){var z,y
z=document.createElement("li",null)
z.textContent=J.Vm($.of)
z.toString
y=H.VM(new W.Cq(z,C.T1.Ph,!1),[null])
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(N.Px()),y.Sg),[H.Kp(y,0)]).Zz()
J.Fc($.of,"")
y=J.OG($.MS)
y.h(y,z)},"call$1","vq",2,0,8],
yW:[function(a){J.Mp(J.l2(a))},"call$1","Px",2,0,8],
Yy:function(){var z,y,x,w,v,u
z=["Code","Test","Publish","Drink","Eat","Watch TV","Learn","Repeat"]
for(y=C.T1.Ph,x=0;x<8;++x){w=document.createElement("li",null)
w.textContent=z[x]
w.toString
v=new W.Cq(w,y,!1)
v.$builtinTypeInfo=[null]
u=new W.xC(0,w,y,W.VF(N.Px()),!1)
u.$builtinTypeInfo=[H.Kp(v,0)]
v=u.u7
if(v!=null&&u.VP<=0)J.qV(u.uv,y,v,!1)
v=J.OG($.MS)
v.h(v,w)}},
em:{
"":"Tp:11;",
call$1:function(a){var z=J.OG($.MS)
return z.V1(z)}}},1],])
...
init.metadata=[{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"WW",void:true,args:[W.ea]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"zx",args:[J.O]},{func:"BG",args:[null],opt:[null]},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
em.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,n6,Ny,OM,QQ,fW,y4,d7,Um,DG,HA,vH,xO,Em,NW,rV,Wy,QF,hs,Wq,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,HL,In,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,A6,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,WS,r0,nK,yp,c1,Mq,Nf,Nc,Mx,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,Zc,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,ox,ZD,vt,wD,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,HY,F0,FK,Gv,kn,CD,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,AP,yH,FA,Av,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,cu,dC,wN,VX,a7,i1,xy,MH,U5,SO,SU,Ca,b8,vs,da,xw,dm,rH,mi,jb,wB,Pu,qh,lz,Rl,Jb,M4,B5,PI,MO,Kd,UO,Bc,VT,Fj,q1,Zz,ly,MF,u8,yU,nP,KA,qB,ez,fI,fZ,dp,B3,CR,Qk,v1,uR,EZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,VG,zL,ec,e7,dx,kE,Fk,RO,Cq,xC,Pb,W9,dW,ue,iY,C0,Rd,D7,Zf,em]}