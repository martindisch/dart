...
this.E6(a,b)
P.HZ(this,z)},function(a){return this.K5(a,null)},"Lp","call$2","call$1","giO",2,2,10,11],
$isvs:true,
$isb8:true,
...
return}throw "Unable to print message: " + String(a)}}],["","file:///C:/Users/Martin/dart/mathtests/web/mathtests.dart",,F,{
"^":"",
Iq:[function(){var z=H.VM(new W.RO(window,C.IU.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.em()),z.Sg),[H.Kp(z,0)]).Zz()
F.ly()
z=J.Vg(document.querySelector("#eancheck"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.Lb()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#isbncheck"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.QA()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#hammingcalculate"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.Cv()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#hammingcorrect"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.ed()),z.Sg),[H.Kp(z,0)]).Zz()
z=H.Go(document.querySelector("#hammingreset"),"$isMi")
z.toString
z=H.VM(new W.Cq(z,C.T1.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.wa()),z.Sg),[H.Kp(z,0)]).Zz()
P.SZ(P.k5(0,0,0,500,0,0),new F.Or())},"call$0","eE",0,0,1],
ly:function(){var z,y
z=window.innerWidth
y=window.innerHeight
document.querySelector("#innerwidth").textContent="Inner width: "+H.d(z)
document.querySelector("#innerheight").textContent="Inner height: "+H.d(y)},
IQ:function(){var z,y,x,w,v,u,t
z=J.Vm(document.querySelector("#eaninput"))
for(y=J.U6(z),x=z.length,w=0,v=0;v<y.gB(z);v+=2){if(v>=x)return H.e(z,v)
u=H.BU(z[v],null,new F.NA())
if(typeof u!=="number")return H.s(u)
w+=u}for(t=0,v=1;v<x;v+=2){y=J.p0(H.BU(z[v],null,new F.Jm()),3)
if(typeof y!=="number")return H.s(y)
t+=y}J.ZP(document.querySelector("#validity"),F.cv(w+t,10,"validity",13,z))},
Ar:function(){var z,y,x,w,v,u,t,s
z=new F.Wb()
y=J.Vm(document.querySelector("#isbninput"))
for(x=J.U6(y),w=y.length,v=0,u=10,t=0;t<x.gB(y);++t){if(t>=w)return H.e(y,t)
s=J.p0(z.call$1(y[t]),u)
if(typeof s!=="number")return H.s(s)
v+=s;--u}J.ZP(document.querySelector("#isbnvalidity"),F.cv(v,11,"isbnvalidity",10,y))},
cv:function(a,b,c,d,e){var z=W.r3("p",null)
J.to(z,c)
if(C.CD.Y(a,b)===0&&J.q8(e)===d){z.textContent="Valid"
J.FI(z.style,"#669900")}else{z.textContent="Invalid"
J.FI(z.style,"#CC0000")}return z},
Tt:function(){var z,y
z={}
z.b=""
y=H.Go(document.querySelector("#hammingmessage"),"$isMi").value
H.bQ($.V9(),new F.Xu(z,y))
H.Go(document.querySelector("#hammingparity"),"$isMi").value=z.b},
SF:function(a){var z,y,x,w
z={}
y=H.VM([],[J.im])
z.a=null
z.b=4
H.bQ($.V9(),new F.qb(z,a,y))
z=y.length
switch(z){case 1:if(0>=z)return H.e(y,0)
x=C.xB.Nj(a,0,y[0])
if(0>=y.length)return H.e(y,0)
z=y[0]
if(z>=a.length)return H.e(a,z)
z=H.BU(a[z],null,null)
if(typeof z!=="number")return H.s(z)
x+=C.CD.bu(1-z)
if(0>=y.length)return H.e(y,0)
x+=C.xB.yn(a,y[0]+1)
break
case 2:if(0>=z)return H.e(y,0)
w=y[0]
if(1>=z)return H.e(y,1)
switch(w+y[1]){case 9:if(0>=a.length)return H.e(a,0)
z=H.BU(a[0],null,null)
if(typeof z!=="number")return H.s(z)
x=C.CD.bu(1-z)+C.xB.yn(a,1)
break
case 11:x=C.xB.Nj(a,0,2)
if(2>=a.length)return H.e(a,2)
z=H.BU(a[2],null,null)
if(typeof z!=="number")return H.s(z)
x=x+C.CD.bu(1-z)+C.xB.yn(a,3)
break
case 10:z=a.length
if(0>=z)return H.e(a,0)
x=a[0]
if(1>=z)return H.e(a,1)
z=H.BU(a[1],null,null)
if(typeof z!=="number")return H.s(z)
x=x+C.CD.bu(1-z)+C.xB.yn(a,2)
break
default:x=a}break
case 3:x=C.xB.Nj(a,0,3)
if(3>=a.length)return H.e(a,3)
z=H.BU(a[3],null,null)
if(typeof z!=="number")return H.s(z)
x=x+C.CD.bu(1-z)+C.xB.yn(a,4)
break
default:x=a}return x},
qN:function(){var z,y,x,w,v,u
z=$.LX()
z.clearRect(0,0,z.canvas.width,z.canvas.height)
$.LX().font="normal 15px Verdana"
y=["Rd","Bl","Br"]
x=[]
for(w=0;w<30;++w){v=[]
for(u=-1;u<C.pr.j1(28);++u){z=C.pr.j1(3)
if(z<0||z>=3)return H.e(y,z)
v.push(y[z])}x.push(v)}F.EQ(x)},
EQ:function(a){var z,y
for(z=20,y=0;y<a.length;++y){F.UM(a[y],z,20)
z+=20}},
UM:function(a,b,c){var z,y,x
for(z=0;z<a.length;++z){y=$.LX()
x=a[z]
y.toString
y.fillText(x,b,c)
c+=20}},
em:{
"^":"Tp:8;",
call$1:function(a){return F.ly()}},
Lb:{
"^":"Tp:8;",
call$1:function(a){return F.IQ()}},
QA:{
"^":"Tp:8;",
call$1:function(a){return F.Ar()}},
Cv:{
"^":"Tp:8;",
call$1:function(a){return F.Tt()}},
ed:{
"^":"Tp:8;",
call$1:function(a){var z=F.SF(J.WB(H.Go(document.querySelector("#hammingmessage"),"$isMi").value,H.Go(document.querySelector("#hammingparity"),"$isMi").value))
document.querySelector("#correctedcode").textContent="Corrected code: "+z
return}},
wa:{
"^":"Tp:8;",
call$1:function(a){H.Go(document.querySelector("#hammingmessage"),"$isMi").value=C.jn.bu(1011)
H.Go(document.querySelector("#hammingparity"),"$isMi").value=""
document.querySelector("#correctedcode").textContent="Corrected code:"
return}},
Or:{
"^":"Tp:8;",
call$1:function(a){return F.qN()}},
NA:{
"^":"Tp:8;",
...
Wb:{
"^":"Tp:17;",
call$1:function(a){if(a.toUpperCase()==="X")return 10
return H.BU(a,null,new F.dN())}},
dN:{
"^":"Tp:8;",
call$1:function(a){return 0}},
Xu:{
...
z={}
z.a=0
J.kH(a,new F.CS(z,this.c))
y=this.b
y.b=y.b+C.CD.bu(C.CD.Y(z.a,2))}},
CS:{
"^":"Tp:8;a,d",
...
if(x!==H.BU(y[w],null,null))this.c.push(z.b)
z.b=z.b+1}},
Li:{
"^":"Tp:8;a,d",
call$1:function(a){var z,y,x,w
...
I.$lazy($,"circles","zx","V9",function(){return[[0,1,3],[0,2,3],[1,2,3]]})
I.$lazy($,"context","eo","LX",function(){var z=H.Go(document.querySelector("#canvas"),"$isNy")
z.toString
return z.getContext("2d")})

init.functionAliases={}
init.metadata=[{func:"uO",args:[J.O]},{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:J.O,args:[J.im]},{func:"Tl",ret:J.im,args:[J.O]},{func:"Pz",void:true,args:[[J.Q,J.im]]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
dN.prototype=$desc
function Xu(b,c){this.b=b
this.c=c}Xu.builtin$cls="Xu"
if(!"name" in Xu)Xu.name="Xu"
$desc=$collectedClasses.Xu
if($desc instanceof Array)$desc=$desc[1]
Xu.prototype=$desc
function CS(a,d){this.a=a
this.d=d}CS.builtin$cls="CS"
...
if($desc instanceof Array)$desc=$desc[1]
qb.prototype=$desc
function Li(a,d){this.a=a
this.d=d}Li.builtin$cls="Li"
if(!"name" in Li)Li.name="Li"
$desc=$collectedClasses.Li
if($desc instanceof Array)$desc=$desc[1]
Li.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,n6,Ny,Y5,Gc,nx,QQ,fW,y4,d7,Um,oJ,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,h4,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,A6,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,i9,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,YS,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,RX,hq,WS,r0,yp,c1,Mq,Nf,Nc,Mx,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,DD,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,ZG,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,DH,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Pe,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,SU,Ca,vs,da,xw,dm,rq,RW,RT,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,Px,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,aE,kM,An,c8,a,mE,Rn,wv,BV,id,Fk,RO,Cq,xC,XY,mg,b0,Pg,Ob,GV,em,Lb,QA,Cv,ed,wa,Or,NA,Jm,Wb,dN,Xu,CS,qb,Li]}